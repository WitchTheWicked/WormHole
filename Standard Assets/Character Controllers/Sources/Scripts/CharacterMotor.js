...
private function UpdateFunction () {
	...
	{
	//set it to stopped
		gameObject.SendMessage("onAnimation",0,SendMessageOptions.DontRequireReceiver);
	}
	else
	{
	//set it to moving
		gameObject.SendMessage("onAnimation",1,SendMessageOptions.DontRequireReceiver);
	}
